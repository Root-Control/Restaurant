...
var validateSessionSecret = function (config, testing) {
  ...
  if (config.sessionSecret === 'MEAN') {
    if (!testing) {
      console.log(chalk.red('+ ADVERTENCIA: es altamente recomendado que cambies la configuración de sessionSecret mientras corras el sistema en producción!'));
      console.log(chalk.red('  Por favor agrega `sessionSecret: process.env.SESSION_SECRET || \'super amazing secret\'` a '));
