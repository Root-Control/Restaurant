(function () {
  ...
  describe('Tables Admin Controller Tests', function () {
    // Initialize global variables
    var TablesAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _TablesService_, _Notification_) {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (TablesService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Table saved successfully!' });
        // Test URL redirection after the table was created
        expect($state.go).toHaveBeenCalledWith('admin.tables.list');
      }));
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Table save error!' });
      });
    });
    ...
    describe('vm.save() as update', function () {
      ...
      it('should  call Notification.error if error', inject(function (TablesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the table and redirect to tables', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Table deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.tables.list');
      });
